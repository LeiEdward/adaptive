        ...
        <article class="main_content">
          <div class="accordionPart grid">
              ...
              <ul class="toolbar">
                ...
                <li><i class="pic" title="上傳圖片"></i></li>
                <li><i class="file" title="上傳檔案"></i></li>
              </ul>
                  ...
                  <div>
                    ...
                    <span>10月期中考.xsl</span>
						...
						<section class="grid-item">
							<div class="qa_title">
								<ul>
									<li><span class="name">我<span style="color:#000;">▸</span>王先生(小明爸爸)</span><span class="time">2017-10-23 14:00</span></li>
									<li>
                    <span class="text">
                    ...
                    <span class="attachedfile">
                      ...
                      <span class="info">留言數(2)</span>
						...
						<section class="grid-item">
							<div class="qa_title">
								<ul>
									<li><span class="name">6年9班老師</span><span class="time">2017-10-23 14:00</span></li>
									<li>
                    <span class="text">
            ...
            <section class="grid-item">
							<div class="qa_title">
								<ul>
									<li><span class="name">給 俊敏家長</span><span class="time">2017-10-23 14:00</span></li>
									<li>
                    <span class="text">
										你尊敬老師，團結同學，是老師的得力助手。令老師感到欣慰的是，你上課精彩的發言，總能搏得同學的讚賞。
										不過，令人遺憾的是你的工作能力有待提高。老師真誠地希望你在工作上要向她人學習，做一名人見人愛的好學生。
            ...
            <section class="grid-item">
							<div class="qa_title">
								<ul>
									<li><span class="name">給 巧敏家長</span><span class="time">2017-10-23 14:00</span></li>
									<li>
                    <span class="text">
										你尊敬老師，團結同學，是老師的得力助手。令老師感到欣慰的是，你上課精彩的發言，總能搏得同學的讚賞。
										不過，令人遺憾的是你的工作能力有待提高。老師真誠地希望你在工作上要向她人學習，做一名人見人愛的好學生。
